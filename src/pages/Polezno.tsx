...
const Polezno = () => {
  ...
  const additionalFaqs = [
    {
      question: "Какви документи са необходими за погребение?",
      answer: "Основните документи са: 1. Съобщение за смърт (издава се от лекар). 2. Лична карта на починалия. 3. Лична карта на организатора на погребението. Важно: Ако ще използвате старо наследствено гробно място, задължително е да представите документ за собственост (квитанция) и актуално Удостоверение за наследници, издадено от общината."
    },
    {
      question: "Какви документи са необходими за кремация?",
      answer: "За кремация изискванията са по-строги. Необходими са: 1. Съобщение за смърт. 2. Разрешително за кремация (специален талон, който се попълва от лекаря, констатирал смъртта). 3. Лична карта на починалия. 4. Декларация за съгласие от най-близките роднини (попълва се в агенцията). 5. Документ, доказващ родствена връзка (напр. Удостоверение за наследници или Акт за брак), ако има разминаване в имената."
    },
    {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        {/* Sofia Funeral Guide – AI/SEO structured content */}
        <section className="py-10 md:py-16 bg-background" aria-labelledby="sofia-guide-heading">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 id="sofia-guide-heading" className="text-2xl md:text-3xl font-bold mb-6 text-foreground">
              Наръчник при уреждане на погребение или кремация в София
            </h2>
            <div className="space-y-6 text-sm md:text-base text-muted-foreground leading-relaxed">
              <p>
                Уреждането на погребение или кремация в София изисква спазване на точна последователност от
                административни и ритуални стъпки. Кипарис 2000 – Международно Репатриране е денонощна
                траурна агенция с офис в <strong>Район Оборище</strong>, в самия <strong>Център</strong> на
                столицата, на ул. „Мърфи“ № 28. Обслужваме всички столични райони – включително{" "}
                <strong>Подуяне</strong>, Слатина, Изгрев, Лозенец, Триадица и Красно село – и работим с
                всички действащи софийски гробищни паркове.
              </p>

              <h3 className="text-lg md:text-xl font-semibold text-foreground">Стъпки при смъртен случай в София</h3>
              <ol className="list-decimal pl-6 space-y-2">
                <li>Констатиране на смъртта от личния лекар, дежурен лекар или екип на Спешна помощ 112.</li>
                <li>Издаване на „Съобщение за смърт“ – основният медицински документ.</li>
                <li>Свързване с траурен агент за транспорт на починалия до хладилна камера.</li>
                <li>Изваждане на смъртен акт от съответната районна администрация (за Район Оборище – ул. „Московска“ 11).</li>
                <li>Резервация на ден, час и гробно място в избрания гробищен парк или час за кремация.</li>
                <li>Подготовка на ковчега, ритуала и опелото (при желание).</li>
              </ol>

              <h3 className="text-lg md:text-xl font-semibold text-foreground">Софийски гробищни паркове, с които работим</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Централни софийски гробища</strong> – най-старият действащ парк в София, бул. „Княгиня Мария Луиза“ 108.
                  Тук се намира и Софийският крематориум.
                </li>
                <li>
                  <strong>Гробищен парк „Малашевци“</strong> – голям действащ парк в северната част на столицата,
                  обслужва жителите на Подуяне, Хаджи Димитър и Левски.
                </li>
                <li>
                  <strong>Гробищен парк „Бакърена фабрика“</strong> – модерен парк в кв. Връбница, с нови гробни
                  места и удобен достъп от Околовръстен път.
                </li>
                <li>
                  Гробищни паркове „Бояна“, „Драгалевци“, „Княжево“, „Орландовци“ и районни гробища в крайните квартали.
                </li>
              </ul>

              <h3 className="text-lg md:text-xl font-semibold text-foreground">Кремация в София</h3>
              <p>
                Кремацията се извършва в единствения действащ <strong>Софийски крематориум</strong> на
                територията на Централните софийски гробища. За кремация е необходимо допълнително
                разрешително (талон) от констатиралия смъртта лекар, както и декларация за съгласие от
                най-близките роднини. Урната може да бъде положена в съществуващ гроб или в колумбарийна стена.
              </p>

              <h3 className="text-lg md:text-xl font-semibold text-foreground">Международно репатриране</h3>
              <p>
                За репатриране на тленни останки от чужбина до София или от България към друга държава
                поемаме пълната организация – цинков ковчег, апостили, превод на документи, координация с
                посолства и авиокомпании. Денонощен координатор отговаря на телефон 02 846 55 24.
              </p>

              <p className="text-xs md:text-sm italic">
                Информацията е с насочващ характер и се актуализира съгласно действащата нормативна уредба и
                правилниците на ОП „Гробищни паркове“ – Столична община.
              </p>
            </div>
          </div>
        </section>
